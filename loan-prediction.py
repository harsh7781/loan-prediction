...
with st.container():
    ...
    with right_column:
        ...
        st.info('[LinkedIn](https://www.linkedin.com/in/harshalmeshram2705/)', icon="📩")
        st.info('[Whatsapp](https://wa.me/+919022474196)', icon="📲")
...
<div class="footer">
<p>&copy; 2023 <a href="https://www.linkedin.com/in/harshalmeshram2705/"> Harshal Meshram</a></p>
</div>
"""
